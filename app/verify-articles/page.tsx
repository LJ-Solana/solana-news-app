    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-4 py-8">
        ...
        <main className="bg-gray-800 p-8 rounded-lg shadow-md">
          <h1 className="text-3xl font-bold mb-6 text-gray-100">How Article Verification Works</h1>
          <div className="space-y-6 text-gray-300">
            <p className="flex items-start">
              <FaInfoCircle className="text-blue-400 mr-2 mt-1 flex-shrink-0" />
              To verify an article, you need to deposit 0.05 worth of News Tokens into an escrow contract. This helps ensure the integrity and commitment of our verification process.
            </p>
            ...
            <ol className="list-decimal list-inside space-y-4 pl-4">
              ...
              <li>When you choose to verify an article, 0.05 worth of News Tokens will be automatically deposited into the escrow contract.</li>
            ...
            <div className="bg-gray-700 border-l-4 border-blue-500 p-4 mt-6">
              ...
              <p>Ensure you have at least $5 worth of News Tokens in your wallet before attempting to verify an article. Insufficient funds will prevent you from participating in the verification process.</p>
            </div>
          </div>
          <div className="mt-8">
