    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-3 sm:p-6 w-full max-w-[90vw] sm:max-w-md overflow-y-auto">
        <div className="flex flex-col items-center justify-center mb-2 sm:mb-4">
          ...
          <h2 className="text-base sm:text-2xl font-bold text-gray-800 text-center">Rating Submitted!</h2>
        </div>
        ...
        <div className="mb-3 sm:mb-6">
          ...
          <a href={`https://solana.fm/tx/${transactionHash}?cluster=devnet-solana`} target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm break-all text-blue-500 hover:text-blue-700 underline">
            {transactionHash}
          </a>
        </div>
        <button
