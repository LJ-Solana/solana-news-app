    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-3 sm:p-6 w-full max-w-[90vw] sm:max-w-md overflow-y-auto">
        ...
        <div className="mb-3 sm:mb-6">
          <p className="font-semibold text-gray-800 text-xs sm:text-base flex items-center">
          ...
          <a href={`https://solana.fm/tx/${onChainVerification}?cluster=devnet-solana`} target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm break-all text-blue-500 hover:text-blue-700 underline">
            {onChainVerification}
          </a>
        </div>
        <button
