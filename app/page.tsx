          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-full transition duration-300 ${
                showVerifiedOnly ? 'bg-white text-gray-700 hover:bg-gray-100' : 'bg-green-500 text-white'
              }`}
            >
              <FaCheckCircle className={`mr-2 ${showVerifiedOnly ? 'text-green-500' : 'text-white'}`} />
